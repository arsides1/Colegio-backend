...
import com.colegio.web.service.SeccionService;
...
public class SeccionController {
	...
	public ResponseEntity<?> listar() {
		/*List<Seccion> grados = this.seccionService.listarSecciones();
		return ResponseEntity.ok(grados);*/
		Collection<Seccion> matricula = seccionService.findAll();
